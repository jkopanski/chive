/**
* Based in part upon 'webpack.config.js'
  ...
  module: {
    rules: [{
      ...
      query: {
        ...
        plugins: [
          // soon this shouldn't be necessary
...
const serverConfig = {
  ...
  module: {
    ...
    rules: config.module.rules.map(rule => (rule.loader !== 'babel-loader'
      ? rule
      : {
        ...rule,
        query: {
          ...rule.query,
          presets: rule.query.presets.map(preset => (preset[0] !== 'env'
            ? preset
            : ['env', {
              targets: {
  ...
  externals: [
    ...
    (context, request, callback) => {
      const isExternal =
        ...
        !request.match(/\.(css|less|scss|sass|sss)$/i)
...
export default [webClient, serverConfig]
